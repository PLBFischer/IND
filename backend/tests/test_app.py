        ...
        "assessments": [
            {
                ...
                "overallRisk": "Medium",
                "fragility": "High",
                "mainRisk": "The main risk is that the exposure signal fails replication and the PK study must be repeated.",
                "impactExplanation": "If that happens, the team would likely rerun the full PK package, adding about one study cycle and repeating the main external cost.",
